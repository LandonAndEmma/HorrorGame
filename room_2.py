...
class Room2:
    def __init__(self):
        ...
        pygame.init()
        pygame.mixer.init()
        pygame.mixer.Channel(1).play(pygame.mixer.Sound("sfx/ambience/creepy_ambiance.wav"), loops=-1)
        ...
        # Load item images
        self.note = pygame.image.load("Sprites/Items/note-1.png")
        self.note_outlined = pygame.image.load("Sprites/Items/note_outlined.png")
        self.note = pygame.transform.scale(self.note, (300, 133))
        self.note_image_rect = self.note.get_rect()
        self.note_image = self.note

        self.silhouette_3 = pygame.image.load("Sprites/Entities/creepy_silhouette_3.png")
        self.silhouette_3_outlined = pygame.image.load("Sprites/Entities/creepy_silhouette_3_disappear.png")
    ...
    def update_image_position(self, mouse_x, mouse_y):
        ...
        if self.x + 1420 > mouse_x > self.x + 930 and self.y + 280 > mouse_y > self.y - 70:
            ...
            pygame.mixer.Channel(1).play(pygame.mixer.Sound("sfx/scary_whoosh.wav"), loops=0)
